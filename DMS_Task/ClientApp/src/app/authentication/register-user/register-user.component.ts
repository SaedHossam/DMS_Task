  ...
  public registerUser = (registerFormValue) => {
    ...
    this._authService.registerUser("api/accounts/registration", user)
      .subscribe(_ => {
        ...
        //this.successMessage = 'Registered Successfully. You Can <a [routerLink]="[' + '/authentication/login' + ']">Login</a> with your Account'
        this.successMessage = `Registered Successfully. You Can 
